...
final class OuraRingInputTests: XCTestCase {
	...
	func testOuraTapSequenceRecognizerIgnoresDuplicateReports() {
		...
		XCTAssertEqual(recognizer.resolvePending(at: 4.54), .doubleTap)
	}
