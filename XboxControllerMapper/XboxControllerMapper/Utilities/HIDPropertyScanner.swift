...
/**
 ...
 This script scans the macOS IORegistry to discover properties of connected Xbox controllers.
 ...
 Usage:
 swift HIDPropertyScanner.swift
 */

func getProperty(_ object: io_object_t, _ key: String) -> Any? {
...
func printAllProperties(_ object: io_object_t, prefix: String = "") {
