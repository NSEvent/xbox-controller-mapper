...
struct OuraMotionSettings: Codable, Equatable {
	...
	var horizontalBoost: Double = 1.0
	var leftTiltBoost: Double = 1.0
    var deadzone: Double = 0.3505420470505618
    var smoothing: Double = 0.7516045616005551
    ...
    init(from decoder: Decoder) throws {
		...
		horizontalBoost = try container.decode(.horizontalBoost, default: 1.0, clampedTo: 1.0...4.0)
		leftTiltBoost = try container.decode(.leftTiltBoost, default: 1.0, clampedTo: 1.0...4.0)
		deadzone = try container.decode(.deadzone, default: 0.3505420470505618, clampedTo: 0.0...0.95)
		smoothing = try container.decode(.smoothing, default: 0.7516045616005551, clampedTo: 0.0...1.0)
