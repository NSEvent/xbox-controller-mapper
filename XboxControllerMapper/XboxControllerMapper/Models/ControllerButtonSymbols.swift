...
extension ControllerButton {
	...
	private var xboxSystemImageName: String? {
		...
		case .leftTouchpadTap, .rightTouchpadTap: return "hand.tap"
		case .micMute: return "mic.slash"
		case .ouraTap: return "hand.tap"
		case .ouraDoubleTap: return "2.circle"
		case .ouraTripleTap: return "3.circle"
		case .ouraFiveTap: return "5.circle"
		...
		case .beamdeskLeftSwipeLeft, .beamdeskRightSwipeLeft: return "arrow.left"
		case .beamdeskLeftSwipeRight, .beamdeskRightSwipeRight: return "arrow.right"
