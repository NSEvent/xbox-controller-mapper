...
アーキテクチャの概要です — セキュリティレビューやコントリビューターに役立ちます。透明性のためにソースコードは全面公開されています。ぜひ[Gumroadでの購入](https://thekevintang.gumroad.com/l/xbox-controller-mapper)を通じてプロジェクトを支援してください。
...
ソースコードは透明性とセキュリティ監査のために公開されています。公式バイナリは[Gumroad](https://thekevintang.gumroad.com/l/xbox-controller-mapper)で購入できます。
